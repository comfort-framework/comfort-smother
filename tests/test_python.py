...
from comfortsmother.python import PythonFile
from comfortsmother.python import Visitor
...
def test_prefix_for_absolute_paths():
    path = os.path.abspath('tests/data/demo.py')
    assert PythonFile(path).prefix == 'tests.data.demo'
